...
class Autorole extends Command {
  ...
  var no_args = lang.admin.autorole.no_args.replace("{wrong}", this.client.emojis.find(e => e.name === "wrongMark")) 
  
  var user = lang.admin.autorole.user.replace("{check}", this.client.emojis.find(e => e.name === "checkMark")) 
  
  var bot = lang.admin.autorole.bot.replace("{check}", this.client.emojis.find(e => e.name === "checkMark")) 
