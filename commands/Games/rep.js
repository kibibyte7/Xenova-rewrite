...
message.channel.send(`${this.client.emojis.cache.find(e => e.name === "wrongMark")} Tu as déjà donné ton point de réputation à quelqu'un, reviens dans **${heures} heures ${minutes} minutes et ${seconds} secondes**`)
