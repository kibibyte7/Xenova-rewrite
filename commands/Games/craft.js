...
if(args[0] === "arme") {
   ...
   message.channel.send(`${this.client.emojis.find(e => e.name === "typing")} ${message.author}, Le prochain niveau de bouclier est : **${nextbouclier}**\n\n**Coût:**\n- ${wood} Bois\n- ${stone} Pierre\n- ${fer} Fer\n- ${gold} Or\n- ${diamant} Diamants\n- ${emeraude} Émeraudes\n- ${prismes} Prismes-parfaits\n- ${antimatter} Anti-matières\n- ${osrizk} Osrizk\n\n**Clique sur les réactions pour confirmer ou annuler.**`).then(m => {  

   function craft() {

   	m.edit(`${check} ${message.author}, Tu as débloqué l'arme **${nextbouclier}**`)  
